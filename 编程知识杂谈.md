...
原因是最初设计 ACSII (1967 年) 的主要目的是在电传打字机上使用，那时候还没有字节的概念，同时当时寄存器也比较昂贵，编码设计需要尽可能精简，用 7 位编码就完全能够满足美国编码的需求。后来 IBM 也将 ASCII 扩展到了 8 位，新增了一些字符，[**EASCII**](https://link.juejin.cn/?target=https%3A%2F%2Fzh.wikipedia.org%2Fwiki%2FEASCII)
