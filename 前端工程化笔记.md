...
>
> 摘自：[unplugin-auto-import - readme](https://github.com/unplugin/unplugin-auto-import)

> unplugin-auto-import 负责 ref、computed、useRouter、useXxx composable、工具函数等 API 自动导入
...
3. 全局安装 [npm-check-updates](https://github.com/raineorshine/npm-check-updates) ，并运行 `ncu -u` 将 `package.json` 中所有的依赖版本号改写为最新的稳定版
   > 也可以考虑 antfu 的 [taze](https://github.com/antfu-collective/taze) ，
