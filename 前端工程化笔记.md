...
<font color=dodgerBlue>**`@babel/preset-env` 的方案也存在一定局限性：**</font>
...
基于上述缺点，可以使用：<font color=fuchsia>更优的 Polyfill 注入方案 transform-runtime</font> 替代
