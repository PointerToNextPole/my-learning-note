...
> [!NOTE]
> 下面官方文档的笔记是 25 年 2 月做的，不过 25 年 11月 就已经一点印象也有没有。这里可以看下 Gemini 的介绍：
> 
> pnpm catalog 协议 是 pnpm v9.5 引入的一项重要功能，旨在解决 Monorepo（多包仓库）中依赖版本管理混乱的问题。
> 
> 核心解决了什么问题？
...
**Catalog 协议**将版本号从 `package.json` 抽离到 `pnpm-workspace.yaml`，实现“一处定义，处处引用”
