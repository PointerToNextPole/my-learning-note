...
摘自：[Vue3 文档 - API - 应用 API - directive](https://v3.cn.vuejs.org/api/application-api.html#directive) Vue3 和 Vue2 自定义指令的区别，摘自：[Vue3 文档 - 从 Vue2 迁移 - 自定义指令](https://v3-migration.vuejs.org/zh/breaking-changes/custom-directives.html) 值得注意的是，由于这里 vue3 文档由 v3.cn.vuejs.org 切换到了 cn.vuejs.org 所以很多内容被修改了，上面摘抄的内容也是。
