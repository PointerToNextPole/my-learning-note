...
因为 <font color=red>Vue3 使用 Proxy 实现响应式</font>，而 <font color=fuchsia>Proxy 只能代理引用类型</font>；所以，<font color=fuchsia>**ref 使用 refImpl 对象对 ref 包装的变量进行了包装**</font>（实现原理参见 [[Vue原理与实现#Ref 实现]]）。
