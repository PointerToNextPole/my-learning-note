...
如果是不同域的情况下，Cookie 是不共享的，可以部署一个认证中心，用于专门处理登录请求的独立的 Web服务
...
一般情况下，<font color=FF0000>动画需要频繁的操作DOM，就会导致页面的性能问题</font>。**可以将动画的 position 属性设置为 absolute 或者 fixed ，将动画脱离文档流，这样他的回流就不会影响到页面了**。
...
在简单请求中，在 ***响应报文*** 中，至少需要设置字段 Access-Control-Allow-Origin。另外，上面提到的 Access-Control-Expose-Headers 返回的 “非其他的” 响应首部，可见 [[计算机网路#Access-Control-Expose-Headers]]
...
<img src="https://s2.loli.net/2022/05/19/IVygGd1lCTf6JoY.png" alt="a4635b395fb64aaab8417f63e64291d4~tplv-k3u1fbpfcp-zoom-in-crop-mark-1304-0-0-0.image" style="zoom:65%;" />
