...
>
> 👀 另外，值得补充的是：今天 (2024/11/8) 在修改一个 uni-app + vue2 的项目时，发现 `<van-button @click.stop="onClick">` 的 `.stop` 始终无法生效，哪怕在 `onClick` 中调用 `event.stopPropagation()` 也不行
...
// TODO：看完了 [【5年以上前端】Vue 和 React 的区别看这里](https://segmentfault.com/a/1190000043837947) 感觉很棒，有空做下笔记
