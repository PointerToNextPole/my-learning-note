...
> [!WARNING]
> 
> 使用 “后瞻断言” 时还是要注意兼容性，虽然 [现代 JS 教程 - 前瞻断言与后瞻断言 # 后瞻断言](https://zh.javascript.info/regexp-lookahead-lookbehind#hou-zhan-duan-yan) 中所陈述的观点 “非 V8 引擎的浏览器不支持后瞻断言，例如 Safari、Internet Explorer” ，在如今 ( 25/8/27 ) 已经部分失效，因为 Safari 从 16.4 版本开始已经支持了。不过， Safari 16.4 也还是 23 年 3 月 发布的。
> 
> ![Lookbehind in JS regular expressions](https://s2.loli.net/2025/08/27/RcWxnU5HtPwl2eZ.png)
